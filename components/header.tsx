...
import { nav, activeKeyForPath, site } from "@/lib/site";
  ...
  return (
    <>
      <header className="site-header">
        <nav className="nav" aria-label="Primary">
          ...
          <div className="nav-cta">
            <a className="btn btn-gold donate-m" href={site.donateUrl}>
              <Icon name="heart" />
              Donate
            </a>
            <button
      ...
      <div className={`mobile-nav${mobileOpen ? " open" : ""}`} id="mobileNav">
        ...
        <div className="mcta">
          <a className="btn btn-gold" href={site.donateUrl} onClick={closeMenus}>
            <Icon name="heart" />
            Donate to Anne&apos;s
          </a>
          <Link
